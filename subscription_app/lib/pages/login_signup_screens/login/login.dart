...
class _Login extends State<Login> {
  ...
  Future loginUser(String email, String password) async {
    ...
    setState(() {
      if (response.statusCode == 200) {
        ...
        userData = data['user'];
        logindata.setString('myuser', userData['fullname']);
        logindata.setString('myuid', userData['uid']);
  ...
  void check_if_already_login() async {
    ...
    String? name = logindata.getString('myuser');
    String? uid = logindata.getString('myuid');
    print('UID IS:::$uid');
    if (newuser == false) {
