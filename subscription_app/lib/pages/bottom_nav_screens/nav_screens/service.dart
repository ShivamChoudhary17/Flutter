          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                InkWell(
                    onTap: () {
                      var newName = serviceModelList[index]
                          .name
                          .substring(
                              0, (serviceModelList[index].name).length - 5)
                          .toUpperCase();
                      Navigator.push(
                        context,
                        SizeRoute(
                            widget: CheckOutPage(
                                  id: '${serviceModelList[index].id}',
                                  timestamp2:
                                      '${serviceModelList[index].timeStamp}',
                                  uid: widget.UID,
                                  name: widget.name,
                                  status: '${serviceModelList[index].status}',
                                  newname: serviceModelList[index].name,
                                  timestamp:
                                      '${serviceModelList[index].timeStamp}',
                                  cost: '${serviceModelList[index].cost}',
                                )),
                      );
                    },
                    child: Text(
