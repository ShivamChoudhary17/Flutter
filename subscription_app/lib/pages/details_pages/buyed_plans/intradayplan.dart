...
class IndradayPlan extends StatefulWidget {
  final UID;
  const IndradayPlan({Key? key, required this.UID,}) : super(key: key);

  @override
  _IndradayPlanState createState() => _IndradayPlanState();
}
class _IndradayPlanState extends State<IndradayPlan> {
