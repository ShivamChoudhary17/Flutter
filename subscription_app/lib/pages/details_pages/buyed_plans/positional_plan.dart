...
import '../intraday_details.dart';

class PositionalPlan extends StatefulWidget {
  final UID;
  const PositionalPlan({Key? key, this.UID,}) : super(key: key);

  @override
  _PositionalPlanState createState() => _PositionalPlanState();
}
class _PositionalPlanState extends State<PositionalPlan> {
  ...
  Future postHomeData() async {
    url = "https://www.jupitertouchlab.co.in/subscription/api/intraday.php";
